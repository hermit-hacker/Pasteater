...
# Package: Pastesite
# Site: http://pastesite.com/
package Pasteater::SiteModules::Pastesite;
...
$SITE = 'http://pastesite.com/recent';
$RAW = 'http://pastesite.com/plain/<ID>.txt';
$MATCH = '<a href="(\d+)" title="View this Paste';
