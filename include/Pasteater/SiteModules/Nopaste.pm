...
# Package: Nopaste
# Site: http://nopaste.me/
package Pasteater::SiteModules::Nopaste;
...
$SITE = 'http://nopaste.me/recent';
$RAW =  'http://nopaste.me/download/<ID>.txt';
$MATCH = '<a href="http://nopaste.me/paste/([a-zA-Z0-9]+)">';
