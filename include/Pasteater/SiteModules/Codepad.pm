...
# Package: Codepad
# Site: http://codepad.org/
package Pasteater::SiteModules::Codepad;
...
$SITE = 'http://codepad.org/recent';
$RAW =  'http://codepad.org/<ID>/raw.txt';
$MATCH = '<a href="http://codepad.org/([a-zA-Z0-9]+)">view';
